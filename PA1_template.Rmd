...
Identify the total steps
Plot the total number of steps taken for each day


## What is the average daily activity pattern?
Calculate the averages of steps taken for "5" minute interval
...
Identify total number of missing values in the dataset
missing values are filled in with mean value
...
new factor variable is created in the dataset with two levels – “weekday” and “weekend” indicating whether a given date is a weekday or weekend day.
